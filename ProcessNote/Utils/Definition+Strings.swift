//
//  Definition+Message.swift
//  ProcessNote
//
//  Created by Takatoshi Miura on 2021/12/26.
//
...
let TITLE_AGREE = NSLocalizedString("AgreeTitle", comment: "")
let MESSAGE_AGREE = NSLocalizedString("AgreeMessage", comment: "")
let TITLE_AGREEMENT = NSLocalizedString("Agree", comment: "")
let TITLE_READ_TERMS = NSLocalizedString("ReadTerms", comment: "")
let MESSAGE_SERVER_COMMUNICATION = NSLocalizedString("ServerCommunication", comment: "")
...
let TITLE_GROUP_ORDER = NSLocalizedString("GroupOrder", comment: "")
...
let MESSAGE_TASK_CREATE_ERROR = NSLocalizedString("TaskCreateError", comment: "")
let TITLE_TASK_EXAMPLE = NSLocalizedString("TaskExample", comment: "")
let TITLE_MEASURE_EXAMPLE = NSLocalizedString("MeasureExample", comment: "")
